...
function graphScroll(){
  var windowHeight,
      dispatch$$1 = dispatch("scroll", "active"),
  ...
  function keydown() {
    ...
    switch (exports.event.keyCode) {
      case 39: // right arrow
      if (exports.event.metaKey) return
      case 40: // down arrow
      case 34: // page down
      delta = exports.event.metaKey ? Infinity : 1 ;break
      case 37: // left arrow
      if (exports.event.metaKey) return
      case 38: // up arrow
      case 33: // page up
      delta = exports.event.metaKey ? -Infinity : -1 ;break
      case 32: // space
      delta = exports.event.shiftKey ? -1 : 1
      ;break
      default: return
    }
    ...
    select(document.documentElement)
      ...
      .transition()
        ...
        .tween("scroll", function() {
          var i = reinterpolate(pageYOffset, sectionPos[i1] + containerStart);
  ...
  rv.sections = function (_x){
    ...
    window['gscrollTimer' + eventId] = timer(reposition);
